...
const TextEditor = () => {
	...
	return (
		<div className="relative w-full h-full flex flex-row max-[]:">
			<textarea
				className=" inset-0 w-[50%] max-w-[50%] h-full px-6 py-12 placeholder:text-center resize-x scrollbar-none border-r text-(--text-muted) outline-none border border-transparent border-r-white focus:border-(--highlight) focus:border-r-white"
				id="normalText"
				autoCorrect="off"
				value={text}
				autoFocus
