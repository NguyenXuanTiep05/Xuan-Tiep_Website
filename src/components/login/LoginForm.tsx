...
const LoginForm = () => {
	...
	return (
		<article id='login-form' className='animate z-10 absolute left-1/2 top-1/2  -translate-x-1/2 -translate-y-1/2 w-120 h-fit bg-(--bg) rounded-2xl shadow-sm shadow-(color:--border) p-6 text-(--text)'>
			...
			<form onSubmit={handleLogin}>
				...
				<div className=' flex w-100%'>
					<div className='text-(--warning) ml-2 mt-6 flex items-center'>{error}</div>
