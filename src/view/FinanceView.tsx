    ...
    setData((prev) => {
      ...
      if (record.type === "income") {
        ...
        const next = {
          ...
          summary: {
            ...prev.summary,
            totalExpenses: prev.summary.totalExpenses + record.value,
          },
        };
        return next;
      }
    ...
    setData((prev) => {
      ...
      if (type === "income") {
        ...
        return {
          ...
          summary: {
            ...prev.summary,
            totalIncome: prev.summary.totalIncome - (removed?.value ?? 0),
          },
        };
      } else {
        ...
        return {
          ...
          summary: {
            ...prev.summary,
            totalExpenses: prev.summary.totalExpenses - (removed?.value ?? 0),
          },
        };
      }
    });
